...
mod tests {
    ...
    fn test_sixlowpan_compress_hop_by_hop_with_icmpv6() {
        ...
        let mut ip_packet = PacketV6 {
            header: Ipv6Repr {
                src_addr: crate::wire::ipv6_from_octets([
                    253, 0, 0, 0, 0, 0, 0, 0, 2, 3, 0, 3, 0, 3, 0, 3,
                ]),
                dst_addr: crate::wire::ipv6_from_octets([
            ...
            payload: IpPayload::Icmpv6(Icmpv6Repr::Rpl(RplRepr::DestinationAdvertisementObject {
                ...
                expect_ack: false,
                sequence: 241,
                dodag_id: Some(crate::wire::ipv6_from_octets([
                    253, 0, 0, 0, 0, 0, 0, 0, 2, 1, 0, 1, 0, 1, 0, 1,
                ])),
                options: &[],
            })),
    ...
    fn test_sixlowpan_compress_hop_by_hop_with_udp() {
        ...
        let addr = crate::wire::ipv6_from_octets([253, 0, 0, 0, 0, 0, 0, 0, 2, 3, 0, 3, 0, 3, 0, 3]);
        let parent_address =
            crate::wire::ipv6_from_octets([253, 0, 0, 0, 0, 0, 0, 0, 2, 1, 0, 1, 0, 1, 0, 1]);
