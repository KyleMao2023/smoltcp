...
mod test {
    ...
    fn packet_repr() -> Repr {
        Repr::EthernetIpv4 {
            ...
            source_protocol_addr: crate::wire::ipv4_from_octets([0x21, 0x22, 0x23, 0x24]),
            target_hardware_addr: EthernetAddress::from_bytes(&[
                0x31, 0x32, 0x33, 0x34, 0x35, 0x36,
            ]),
            target_protocol_addr: crate::wire::ipv4_from_octets([0x41, 0x42, 0x43, 0x44]),
        }
    }
